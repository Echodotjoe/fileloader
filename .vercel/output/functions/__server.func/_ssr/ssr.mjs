...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-CWzFSAyS.mjs");
...
var manifest = { "ecf24bba301187fcccfeb9e656c1085dc149f38da1d7ce562ea6142cb1e00adb": {
	functionName: "listArcadeFiles_createServerFn_handler",
	importer: () => import("./catalog-BPgA_JmP.mjs")
} };
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-DVP0n8N2.mjs").then((n) => n.t),
